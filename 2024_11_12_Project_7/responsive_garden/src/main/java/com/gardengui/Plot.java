...
public class Plot {
    ...
    public void grow() {
        if(plantType.equals("flower")) {
            ...
            if(asciiRepresentation[1][2] == backgroundChar) {
                flowerGrowHelper(growthPositions);
            } else if(asciiRepresentation[0][2] == backgroundChar) {
                flowerGrowHelper(secondGrowthPositions);
            } else if(asciiRepresentation[0][1] == backgroundChar) {
        ...
        if(plantType.equals("fruit")) {
            ...
            for(int i = 0; i < 5; i++) {
                if(asciiRepresentation[2][i] == backgroundChar) {
        ...
        if(plantType.equals("vegetable")) {
            boolean exitedNormally = true;
            for(int i = 0; i < 5; i++) {
                if(asciiRepresentation[i][2] == backgroundChar) {
